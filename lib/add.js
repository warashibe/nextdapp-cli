...
var updateApis = function updateApis(_ref4) {
  ...
  if (_ramdam2.default.xNil(json.api)) {
    ...
    for (var k in json.api || {}) {
      var func_path = (0, _util.resolve)("pages/api/" + json.api[k] + ".js");
      var api = ["const path = require(\"path\")", "import { " + k + " } from \"" + name + "\"", "import conf from \"../../conf\"", "export default " + k + "({ conf: conf })"];
