...
var updateComponents = function updateComponents(_ref3) {
  ...
  var src = "".concat(noinstall === true ? "../../" + tar_path : name, "/lib");
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var v = _step.value;
      var code = ["import bind from \"nd/bind\"", "import * as _ from \"".concat(src, "/components/").concat(v, "\""), "export default bind(_.Component, _.props)"];
...
var updateStatic = function updateStatic(_ref5) {
  ...
  var static_path = (0, _ramda.isNil)(tar_path) ? (0, _util.resolve)("node_modules/".concat(name, "/static")) : (0, _util.resolve)("".concat(tar_path, "/static"));
...
var updateFirestore = function updateFirestore(_ref6) {
  ...
  var firestore_path = (0, _ramda.isNil)(tar_path) ? (0, _util.resolve)("node_modules/".concat(name, "/firebase/firestore.rules")) : (0, _util.resolve)("".concat(tar_path, "/firebase/firestore.rules"));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            tar_path = (0, _ramda.when)(xNil, function (v) {
              return v.replace(/\/$/, "");
            })(tar);
