...
var updateComponents = function updateComponents(_ref3) {
  ...
  var src = noinstall === false && _ramdam["default"].xNil(tar_path) ? "../../" + tar_path : name;
...
var updateApis = function updateApis(_ref4) {
  ...
  if (_ramdam["default"].xNil(json.api)) {
    ...
    for (var k in json.api || {}) {
      ...
      var api = ["const path = require(\"path\")", "import { ".concat(k, " } from \"").concat(src, "\""), "import conf from \"nd.config\"", "export default ".concat(k, "({ conf: conf })")];
