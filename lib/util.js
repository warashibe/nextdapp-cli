...
exports.updatePlugins = exports.getPlugins = exports.getJSON = exports.spawnp = exports.updateProps = exports.updateEpics = exports.resolve = exports.getPre = exports.isRoot = void 0;
...
var updateEpics = function updateEpics(_ref) {
  ...
  for (var pre in plugins) {
    ...
    var src = noinstall === false && _ramdam["default"].xNil(json.path) ? "../" + json.path : json.name;

    var _iterator = _createForOfIteratorHelper(json.epics || []),
        _step;
...
var updateProps = function updateProps(_ref2) {
  ...
  for (var pre in plugins) {
    var json = plugins[pre];
    var src = noinstall === false && _ramdam["default"].xNil(json.path) ? "../" + json.path : json.name;
    props.push("mergeProps(\"".concat(pre, "\", require(\"").concat(src, "\").init)"));
  }
